# Generated by Django 5.0.7 on 2024-08-24 04:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=150, verbose_name='所在地')),
                ...
                ('employee', models.CharField(max_length=50, verbose_name='従業員数')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='登録日時')),
                ('updated_at', models.DateTimeField(auto_now=True, null=True, verbose_name='更新日時')),
            ],
            options={
