...
urlpatterns = [
    ...
    path('management/<int:user_id>/category/', views.ManagementCategoryView.as_view(), name="managementcategory"),
    path('management/<int:user_id>/category/create/', views.ManagementCategoryCreateView.as_view(), name="managementcategorycreate"),
    path('management/<int:user_id>/category/<int:pk>/update/', views.ManagementCategoryUpdateView.as_view(), name="managementcategoryupdate"),
    path('management/<int:user_id>/category/<int:pk>/delete/', views.ManagementCategoryDeleteView.as_view(), name="managementcategorydelete"),
