...
urlpatterns = [
    ...
    path('restaurant/', views.RestaurantKeywordListView.as_view(), name='keyword'),
    path('restaurant/category/<int:category_id>', views.RestaurantCategoryListView.as_view(), name='category'),
