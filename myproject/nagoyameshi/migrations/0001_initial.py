    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(max_length=1000, verbose_name='店舗説明')),
                ('address', models.CharField(max_length=200, verbose_name='店舗住所')),
                ('price', models.CharField(choices=[('1', '¥0~999'), ('2', '¥1,000~1,999'), ('3', '¥2,000~2,999'), ('4', '¥3,000~3,999'), ('5', '¥4,000~4,999'), ('6', '¥5,000~9,999'), ('7', '¥10,000~30,000'), ('8', '¥30,000~')], max_length=20, verbose_name='価格帯')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=24, validators=[django.core.validators.RegexValidator(message='パスワードは半角8文字以上24文字以内で大文字と記号（.?/-）をそれぞれ1文字以上含めてください', regex='^(?=.*[A-Z])(?=.*[.?/-])[a-zA-Z0-9.?/-]{8,24}$')], verbose_name='パスワード')),
