...
urlpatterns = [
    ...
    path('restaurant/reservationlist/', views.ReservationListView.as_view(), name="reservationlist"),
    path('restaurant/reservationlist/all/', views.ReservationListAllView.as_view(), name="reservationlistall"),
    path('restaurant/reservationdelete/<int:pk>/', views.ReservationDeleteView.as_view(), name="reservationdelete"),
